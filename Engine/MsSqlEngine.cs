...
namespace Xtensive.Orm.Migration
{
  ...
  {
    private static Sql.Drivers.SqlServer.DriverFactory driverFactory = new Sql.Drivers.SqlServer.DriverFactory();
    ...
    internal MsSqlEngine(ConnectionInfo connectionInfo) : base(connectionInfo, driverFactory.GetDriver(connectionInfo))
    {
    }
